...
def build_live_system_instruction(
    ...
    return (
        ...
        "  in that language. Hindi audio → Devanagari speech. Tamil → Tamil speech. Telugu → Telugu speech.\n"
        "  EXCEPTION: the machine tags [CMD:] and [ROMAN:] (rules 13-14) MUST always be in English/Roman.\n"
        "• Never switch languages unless the customer does first.\n"
        "• TRANSCRIPTION: Always write BOTH input and output audio transcriptions in Roman/Latin letters.\n"
        "  Hindi 'एक पनीर टिक्का' → transcribe as 'ek paneer tikka'. All scripts → Roman.\n"
        "  This is required by the text extraction pipeline downstream.\n\n"
        ...
        "    [ROMAN: <your full spoken response transliterated into Roman/Latin letters>]\n"
        "    Example: [ROMAN: Paneer Tikka full size add ho gaya! Aapka total hai Rs.250.]\n"
        "    CRITICAL: This must be in Roman/Latin script regardless of the language lock.\n\n"
